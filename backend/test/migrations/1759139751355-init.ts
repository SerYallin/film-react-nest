...
export class Init1759139751355 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      create table public.schedules (
        ...
        "filmId" uuid,
        foreign key ("filmId") references public.films (id)
      ...
      insert into public.schedules (id, daytime, hall, rows, seats, price, taken, "filmId")
      values  ('f2e429b0-685d-41f8-a8cd-1d8cb63b99ce', '2024-06-28T10:00:53+03:00', 0, 5, 10, 350, '{}', '0e33c7f6-27a7-4aa0-8e61-65d7e5effecf'),
